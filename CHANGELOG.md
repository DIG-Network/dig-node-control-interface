...
### Features
- Declare control.mirror.reconcile for reconciling mirror coins to the current advertise URL (#53)

## [0.33.0] - 2026-09-05

### Features
- **control:** Settable mirror advertise-URL override (control.config.setMirrorAdvertiseUrls) (#51)
...
### Features
- **wallet:** Declare control.wallet.resetCoinDb, discarding the cached coin database (#48)
...
### Features
- **wallet:** Declare control.wallet.operatorAddress, the node's own MACHINE wallet (#42)

## [0.28.0] - 2026-09-01

### Features
- **mirror:** Add MirrorBondState::Unadvertised, the switch-on-but-nothing-to-advertise state (#41)
